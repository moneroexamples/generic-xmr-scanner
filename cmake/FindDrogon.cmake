...
set_target_properties(Drogon::Drogon PROPERTIES
      ...
      "${CMAKE_CURRENT_SOURCE_DIR}/ext/drogon/lib/inc;${CMAKE_CURRENT_SOURCE_DIR}/ext/drogon/lib/src;${CMAKE_CURRENT_SOURCE_DIR}/ext/drogon/orm_lib/inc;${CMAKE_CURRENT_SOURCE_DIR}/ext/drogon/trantor;${JSONCPP_INCLUDE_DIRS};${MYSQL_INCLUDE_DIR}")
